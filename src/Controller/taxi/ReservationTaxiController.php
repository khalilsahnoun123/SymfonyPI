...
use App\Form\taxi\ReservationTaxiType;
use App\Repository\taxi\ReservationTaxiRepository;
...
final class ReservationTaxiController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Admin/taxi/reservation_taxi/new.html.twig', [
    ...
    {
        return $this->render('Admin/taxi/reservation_taxi/show.html.twig', [
            'reservation_taxi' => $reservationTaxi,
        ]);
    }
    ...
    public function edit(Request $request, ReservationTaxi $reservationTaxi, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Admin/taxi/reservation_taxi/edit.html.twig', [
            'reservation_taxi' => $reservationTaxi,
            'form' => $form,
        ]);
    }
