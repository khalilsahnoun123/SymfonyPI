...
use Symfony\Component\Validator\Constraints as Assert; // ✅ Already good
...
class Covoiturage
{
    ...
    #[Assert\Regex(
        pattern: "/^\D+$/",
        message: "Le lieu de départ ne doit pas contenir de chiffres."
    )]
    ...
    #[Assert\Regex(
        pattern: "/^\D+$/",
        message: "Le lieu de destination ne doit pas contenir de chiffres."
    )]
    ...
    #[Assert\Type(
        type: 'integer',
        message: "Le nombre de places doit être un nombre entier sans lettres ni caractères spéciaux."
    )]
