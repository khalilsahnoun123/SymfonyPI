...
class Reservation
{
    ...
    private ?string $flouci_payment_id = null;
    ...
    public function getFlouciPaymentId(): ?string
    {
        return $this->flouci_payment_id;
    }

    public function setFlouciPaymentId(?string $id): static
    {
        $this->flouci_payment_id = $id;
        return $this;
    }
    ...
    public function setPaymentLink(?string $link): static
    {
